"""
Test suite for Student API endpoints using pytest
"""
import pytest
...
class TestStudentAPI:
    ...
    @pytest.fixture
    def api_client(self):
        """Fixture to provide Student API client instance"""
    ...
    def test_complete_student_crud_workflow(self, api_client, test_data):
        """Test complete CRUD workflow for students in sequence"""
        # CREATE
        name = test_data.get_random_name()
        age = 35
        created_student = api_client.create_student(name, age)
